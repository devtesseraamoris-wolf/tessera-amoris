...
(function() {
    ...
    const curatedDatasets = {
        'PY': [
            {
                code: 'asuncion-capital-district',
            ...
            },
            {
                code: 'alto-paraguay',
                name: 'Alto Paraguay',
                cities: ['Fuerte Olimpo', 'Bahía Negra', 'Carmelo Peralta', 'Puerto Casado', 'Puerto Guaraní']
            },
            {
                code: 'alto-parana',
                name: 'Alto Paraná',
                cities: ['Ciudad del Este', 'Presidente Franco', 'Hernandarias', 'Minga Guazú', 'Santa Rita', 'Itakyry']
            },
            {
                code: 'amambay',
                name: 'Amambay',
            ...
            },
            {
                code: 'boqueron',
                name: 'Boquerón',
                cities: ['Filadelfia', 'Loma Plata', 'Mariscal Estigarribia', 'Neuland', 'General Eugenio A. Garay']
            },
            {
                code: 'caaguazu',
                name: 'Caaguazú',
                cities: ['Coronel Oviedo', 'Caaguazú', 'Repatriación', 'Dr. Juan Manuel Frutos', 'Raúl Arsenio Oviedo', 'San José de los Arroyos']
            },
            {
                code: 'caazapa',
                name: 'Caazapá',
                cities: ['Caazapá', 'San Juan Nepomuceno', 'Abaí', 'Yuty', 'Tavaí', 'Maciel']
            },
            {
                code: 'canindeyu',
                name: 'Canindeyú',
                cities: ['Salto del Guairá', 'Curuguaty', 'Katueté', 'Ybyrarobaná', 'Villa Ygatimí', 'Corpus Christi']
            },
            {
                code: 'central',
                name: 'Central',
                cities: ['San Lorenzo', 'Luque', 'Capiatá', 'Lambaré', 'Fernando de la Mora', 'Ñemby', 'Mariano Roque Alonso', 'Villa Elisa', 'Itauguá', 'Limpio']
            },
            {
                code: 'concepcion',
                name: 'Concepción',
                cities: ['Concepción', 'Horqueta', 'Loreto', 'Belén', 'Vallemí', 'Azotey']
            },
            {
                code: 'cordillera',
                name: 'Cordillera',
                cities: ['Caacupé', 'Eusebio Ayala', 'Itacurubí de la Cordillera', 'Tobatí', 'San Bernardino', 'Arroyos y Esteros']
            },
            {
                code: 'guaira',
                name: 'Guairá',
                cities: ['Villarrica', 'Coronel Martínez', 'Borja', 'Iturbe', 'Mbocayaty', 'Félix Pérez Cardozo']
            },
            {
                code: 'itapua',
                name: 'Itapúa',
                cities: ['Encarnación', 'Hohenau', 'Obligado', 'Bella Vista', 'Capitán Miranda', 'Fram', 'Jesús de Tavarangüé']
            },
            {
                code: 'misiones',
                name: 'Misiones',
                cities: ['San Juan Bautista', 'Ayolas', 'San Ignacio', 'San Miguel', 'Villa Florida', 'Santa Rosa']
            },
            {
                code: 'neembucu',
                name: 'Ñeembucú',
                cities: ['Pilar', 'Humaitá', 'Paso de Patria', 'Isla Umbú', 'Desmochados', 'Mayor Martínez']
            },
            {
                code: 'paraguari',
                name: 'Paraguarí',
                cities: ['Paraguarí', 'Carapeguá', 'Pirayú', 'Yaguarón', 'La Colmena', 'Quiindy']
            },
            {
                code: 'presidente-hayes',
                name: 'Presidente Hayes',
                cities: ['Villa Hayes', 'Nanawa', 'Pozo Colorado', 'Teniente Irala Fernández', 'Nueva Asunción', 'José Falcón']
            },
            {
                code: 'san-pedro',
                name: 'San Pedro',
                cities: ['San Pedro de Ycuamandiyú', 'Santa Rosa del Aguaray', 'Choré', 'Lima', 'Itacurubí del Rosario', 'Yataity del Norte']
            }
        ],
        'AL': [
    ...
    async function getStates(countryCode) {
        ...
        const states = fallbackDatasets[countryCode] ? [...fallbackDatasets[countryCode]] : [];
    ...
    async function getCities(countryCode, stateCode) {
        ...
        const cities = fallbackCityMap[cacheKey] ? [...fallbackCityMap[cacheKey]] : [];
